  ...
  return (
    <Tailwind>
      <Html>
        ...
        <Preview>Verify your email address in just one click</Preview>
        <Body className="px-2 py-10 font-sans">
          <Container className="max-w-[600px] bg-white p-[24px] sm:p-[48px]">
            ...
            <Section className="mt-[20px]">
              ...
              <Text className="text-[16px] leading-[26px] text-[#4b5563]">
                We received a request to verify your email address. To complete
                the verification process and activate your account, please click
                the button below.
              </Text>
            </Section>
            ...
            <Section className="rounded-[8px] border-l-[4px] border-l-[#3b82f6] bg-[#f9fafb] p-[16px]">
              <Text className="m-0 text-[14px] leading-[22px] text-[#4b5563]">
                ...
                request this verification, please ignore this email or contact
